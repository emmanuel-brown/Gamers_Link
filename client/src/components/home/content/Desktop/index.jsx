        ...
        <div className="part-one">
            ...
            <section className="sections-2 section">
                <div className="sections-2-left">
                    <img className="sections-2-left-img" src="https://images.unsplash.com/flagged/photo-1552725391-4ae757a7ff8c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60" alt="developer"/>
                </div>
            ...
            <section className="sections-3">
                <section className="sections-3 section">
                    ...
                    <div className="sections-3-right">
                        <h3 className="sections-3-right-header header">Developers</h3>
                        <p className="text sections-3-right-text">Hello developers and game creator. Finally a go to dedicated platform to intake valuable data from your game. Inform and get feedback for users users. *this text is not final</p>
                    </div>
                    </section>
            </section>
        </div>
